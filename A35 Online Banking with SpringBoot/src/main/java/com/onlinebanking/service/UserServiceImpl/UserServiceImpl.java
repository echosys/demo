...
public class UserServiceImpl implements UserService{
    ...
    public List<User> findByUserTypeId(int usertypeid){return userDao.findByUserTypeId(usertypeid);}
    ...
    public User createUser(User user, Set<UserRole> userRoles) {
        ...
        if (localUser != null) {
            ...
            if(user.getUserTypeId() == UserTypes.MERCHANT.getType() || user.getUserTypeId() == UserTypes.CUSTOMER.getType()) {
                user.setPrimaryAccount(accountService.createPrimaryAccount());

                user.setCreditAccount(accountService.createCreditAccount());
            }
//            user.setPrimaryAccount(accountService.createPrimaryAccount());
